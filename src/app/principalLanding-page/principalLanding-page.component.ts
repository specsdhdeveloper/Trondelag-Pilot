...
@Component({
  ...
  templateUrl: './principalLanding-page.component.html',
  styleUrls: ['./principalLanding-page.component.scss']
})
export class PrincipalLandingPageComponent implements OnInit {
